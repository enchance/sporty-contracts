...
const CONTRACT = keccak256(toUtf8Bytes('ARENA_CONTRACT'))
...
describe('Gatekeeper', () => {
    ...
    it('Role Management', async () => {
        ...
        await expect(gate.connect(gkuser).addRole('ARENA_CONTRACT', 'ARENA_STAFF', [])).is.revertedWith(INVALID_ROLE)
        ...
        for(let account of [adminuser, staffuser, owneruser]) {
