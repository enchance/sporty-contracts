...
let owneruser: SignerWithAddress, foouser: SignerWithAddress, baruser: SignerWithAddress
...
export const init_contract = async () => {
    [owneruser, foouser, baruser] = await ethers.getSigners()
    ...
    return [factory, contract, owneruser, foouser, baruser]
}
